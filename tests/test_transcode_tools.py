...
def test_opus_mono_transcode():
    ...
    tcw_transcode_tools.ffmpeg_audio_transcode(test_file, "tests/", "mono_test", "opus", "24000", "1")
...
def test_transcoding(output_file, codec, q_or_b, channels):
    test_file = "tests/stereo_test.wav"
    tcw_transcode_tools.ffmpeg_audio_transcode(test_file, "tests/", output_file, codec, q_or_b, channels)
